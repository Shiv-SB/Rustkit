...
describe("distance.euclidean", () => {
    test("should compute Euclidean distance", () => {
        expect(distance.euclidean(new Float32Array([0, 0]), new Float32Array([3, 4]))).toBeCloseTo(5, 4);
    });

    test("should return 0 for identical vectors", () => {
        expect(distance.euclidean(new Float32Array([1, 2, 3]), new Float32Array([1, 2, 3]))).toBeCloseTo(0, 4);
    });

    test("should handle single element", () => {
        expect(distance.euclidean(new Float32Array([3]), new Float32Array([7]))).toBeCloseTo(4, 4);
    });

    test("should throw on mismatched lengths", () => {
        expect(() => distance.euclidean(new Float32Array([1, 2]), new Float32Array([1]))).toThrow("Vectors must have the same length");
    });
});
...
describe("distance.manhattan", () => {
    ...
    test("should throw on mismatched lengths", () => {
        expect(() => distance.manhattan(new Float32Array([1]), new Float32Array([1, 2]))).toThrow("Vectors must have the same length");
    });
});
...
describe("distance.cosineSimilarity", () => {
    ...
    test("should throw on mismatched lengths", () => {
        expect(() => distance.cosineSimilarity(new Float32Array([1, 2]), new Float32Array([1]))).toThrow("Vectors must have the same length");
    });
});
...
describe("distance.hammingDistance", () => {
    ...
    test("should throw on mismatched lengths", () => {
        expect(() => distance.hammingDistance(new Int32Array([1, 2]), new Int32Array([1]))).toThrow("Vectors must have the same length");
    });
});

describe("distance.jaccardSimilarity", () => {
    test("should return 1 for identical sets", () => {
        expect(distance.jaccardSimilarity(new Int32Array([1, 2, 3]), new Int32Array([1, 2, 3]))).toBeCloseTo(1, 4);
    });

    test("should return 0 for disjoint sets", () => {
        expect(distance.jaccardSimilarity(new Int32Array([1, 2]), new Int32Array([3, 4]))).toBeCloseTo(0, 4);
    });

    test("should compute partial overlap", () => {
        const result = distance.jaccardSimilarity(new Int32Array([1, 2, 3]), new Int32Array([2, 3, 4]));
        expect(result).toBeCloseTo(0.5, 4); // intersection=2, union=4
    });
});
...
describe("distance.chebyshev", () => {
    ...
    test("should throw on mismatched lengths", () => {
        expect(() => distance.chebyshev(new Float32Array([1]), new Float32Array([1, 2]))).toThrow("Vectors must have the same length");
    });
});
